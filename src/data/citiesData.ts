...
// --- Auto-correction des departmentCode manquants ---
const departmentFixMap: Record<string, { department: string; departmentCode: string }> = {
  // Auvergne-Rhône-Alpes
  "voiron": { department: "Isère", departmentCode: "38" },
  "meylan": { department: "Isère", departmentCode: "38" },
  "montbrison": { department: "Loire", departmentCode: "42" },
  "saint-just-saint-rambert": { department: "Loire", departmentCode: "42" },
  "issoire": { department: "Puy-de-Dôme", departmentCode: "63" },
  "villefranche-sur-saone": { department: "Rhône", departmentCode: "69" },
  "albertville": { department: "Savoie", departmentCode: "73" },
  // Bourgogne-Franche-Comté
  "beaune": { department: "Côte-d'Or", departmentCode: "21" },
  "montbeliard": { department: "Doubs", departmentCode: "25" },
  "pontarlier": { department: "Doubs", departmentCode: "25" },
  "vesoul": { department: "Haute-Saône", departmentCode: "70" },
  "dole": { department: "Jura", departmentCode: "39" },
  "lons-le-saunier": { department: "Jura", departmentCode: "39" },
  "nevers": { department: "Nièvre", departmentCode: "58" },
  "le-creusot": { department: "Saône-et-Loire", departmentCode: "71" },
  "montceau-les-mines": { department: "Saône-et-Loire", departmentCode: "71" },
  "sens": { department: "Yonne", departmentCode: "89" },
  // Bretagne
  "lannion": { department: "Côtes-d'Armor", departmentCode: "22" },
  "lamballe-armor": { department: "Côtes-d'Armor", departmentCode: "22" },
  "concarneau": { department: "Finistère", departmentCode: "29" },
  "landerneau": { department: "Finistère", departmentCode: "29" },
  "morlaix": { department: "Finistère", departmentCode: "29" },
  "fougeres": { department: "Ille-et-Vilaine", departmentCode: "35" },
  "bruz": { department: "Ille-et-Vilaine", departmentCode: "35" },
  "vitre": { department: "Ille-et-Vilaine", departmentCode: "35" },
  // Centre-Val de Loire
  "vierzon": { department: "Cher", departmentCode: "18" },
  "dreux": { department: "Eure-et-Loir", departmentCode: "28" },
  "romorantin-lanthenay": { department: "Loir-et-Cher", departmentCode: "41" },
  "vendome": { department: "Loir-et-Cher", departmentCode: "41" },
  // Grand Est
  "charleville-mezieres": { department: "Ardennes", departmentCode: "08" },
  "sedan": { department: "Ardennes", departmentCode: "08" },
  "haguenau": { department: "Bas-Rhin", departmentCode: "67" },
  "selestat": { department: "Bas-Rhin", departmentCode: "67" },
  "saint-louis": { department: "Haut-Rhin", departmentCode: "68" },
  "saint-dizier": { department: "Haute-Marne", departmentCode: "52" },
  "chaumont": { department: "Haute-Marne", departmentCode: "52" },
  "epernay": { department: "Marne", departmentCode: "51" },
  "luneville": { department: "Meurthe-et-Moselle", departmentCode: "54" },
  "toul": { department: "Meurthe-et-Moselle", departmentCode: "54" },
  "longwy": { department: "Meurthe-et-Moselle", departmentCode: "54" },
  "verdun": { department: "Meuse", departmentCode: "55" },
  "forbach": { department: "Moselle", departmentCode: "57" },
  "sarreguemines": { department: "Moselle", departmentCode: "57" },
  "epinal": { department: "Vosges", departmentCode: "88" },
  "saint-die-des-vosges": { department: "Vosges", departmentCode: "88" },
  // Hauts-de-France
  "soissons": { department: "Aisne", departmentCode: "02" },
  "laon": { department: "Aisne", departmentCode: "02" },
  "chteau-thierry": { department: "Aisne", departmentCode: "02" },
  "cambrai": { department: "Nord", departmentCode: "59" },
  "maubeuge": { department: "Nord", departmentCode: "59" },
  "armentieres": { department: "Nord", departmentCode: "59" },
  "hazebrouck": { department: "Nord", departmentCode: "59" },
  "denain": { department: "Nord", departmentCode: "59" },
  "saint-amand-les-eaux": { department: "Nord", departmentCode: "59" },
  "compiegne": { department: "Oise", departmentCode: "60" },
  "creil": { department: "Oise", departmentCode: "60" },
  "arras": { department: "Pas-de-Calais", departmentCode: "62" },
  "lens": { department: "Pas-de-Calais", departmentCode: "62" },
  "henin-beaumont": { department: "Pas-de-Calais", departmentCode: "62" },
  "bethune": { department: "Pas-de-Calais", departmentCode: "62" },
  "abbeville": { department: "Somme", departmentCode: "80" },
  // Normandie
  "lisieux": { department: "Calvados", departmentCode: "14" },
  "vire-normandie": { department: "Calvados", departmentCode: "14" },
  "vernon": { department: "Eure", departmentCode: "27" },
  "louviers": { department: "Eure", departmentCode: "27" },
  "saint-lo": { department: "Manche", departmentCode: "50" },
  "alenon": { department: "Orne", departmentCode: "61" },
  "saint-etienne-du-rouvray": { department: "Seine-Maritime", departmentCode: "76" },
  "dieppe": { department: "Seine-Maritime", departmentCode: "76" },
  "fecamp": { department: "Seine-Maritime", departmentCode: "76" },
  "elbeuf": { department: "Seine-Maritime", departmentCode: "76" },
  // Nouvelle-Aquitaine
  "cognac": { department: "Charente", departmentCode: "16" },
  "saintes": { department: "Charente-Maritime", departmentCode: "17" },
  "rochefort": { department: "Charente-Maritime", departmentCode: "17" },
  "royan": { department: "Charente-Maritime", departmentCode: "17" },
  "bressuire": { department: "Deux-Sèvres", departmentCode: "79" },
  "bergerac": { department: "Dordogne", departmentCode: "24" },
  "villenave-d-ornon": { department: "Gironde", departmentCode: "33" },
  "la-teste-de-buch": { department: "Gironde", departmentCode: "33" },
  "libourne": { department: "Gironde", departmentCode: "33" },
  "ambares-et-lagrave": { department: "Gironde", departmentCode: "33" },
  "biscarrosse": { department: "Landes", departmentCode: "40" },
  "villeneuve-sur-lot": { department: "Lot-et-Garonne", departmentCode: "47" },
  "marmande": { department: "Lot-et-Garonne", departmentCode: "47" },
  "hendaye": { department: "Pyrénées-Atlantiques", departmentCode: "64" },
  "chtellerault": { department: "Vienne", departmentCode: "86" },
  // Occitanie
  "pamiers": { department: "Ariège", departmentCode: "09" },
  "rodez": { department: "Aveyron", departmentCode: "12" },
  "millau": { department: "Aveyron", departmentCode: "12" },
  "ales": { department: "Gard", departmentCode: "30" },
  "bagnols-sur-ceze": { department: "Gard", departmentCode: "30" },
  "beaucaire": { department: "Gard", departmentCode: "30" },
  "auch": { department: "Gers", departmentCode: "32" },
  "muret": { department: "Haute-Garonne", departmentCode: "31" },
  "plaisance-du-touch": { department: "Haute-Garonne", departmentCode: "31" },
  "castanet-tolosan": { department: "Haute-Garonne", departmentCode: "31" },
  "blagnac": { department: "Haute-Garonne", departmentCode: "31" },
  "agde": { department: "Hérault", departmentCode: "34" },
  "lunel": { department: "Hérault", departmentCode: "34" },
  "mauguio": { department: "Hérault", departmentCode: "34" },
  "cahors": { department: "Lot", departmentCode: "46" },
  "castres": { department: "Tarn", departmentCode: "81" },
  "gaillac": { department: "Tarn", departmentCode: "81" },
  "albi": { department: "Tarn", departmentCode: "81" },
  // Pays de la Loire
  "vertou": { department: "Loire-Atlantique", departmentCode: "44" },
  "couron": { department: "Loire-Atlantique", departmentCode: "44" },
  "pornic": { department: "Loire-Atlantique", departmentCode: "44" },
  "guerande": { department: "Loire-Atlantique", departmentCode: "44" },
  "saumur": { department: "Maine-et-Loire", departmentCode: "49" },
  "sevremoine": { department: "Maine-et-Loire", departmentCode: "49" },
  "beaupreau-en-mauges": { department: "Maine-et-Loire", departmentCode: "49" },
  "chemille-en-anjou": { department: "Maine-et-Loire", departmentCode: "49" },
  "mauges-sur-loire": { department: "Maine-et-Loire", departmentCode: "49" },
  "segre-en-anjou-bleu": { department: "Maine-et-Loire", departmentCode: "49" },
  "oree-d-anjou": { department: "Maine-et-Loire", departmentCode: "49" },
  "laval": { department: "Mayenne", departmentCode: "53" },
  "change": { department: "Mayenne", departmentCode: "53" },
  "chateau-gontier-sur-mayenne": { department: "Mayenne", departmentCode: "53" },
  "mayenne": { department: "Mayenne", departmentCode: "53" },
  "la-ferte-bernard": { department: "Sarthe", departmentCode: "72" },
  "sable-sur-sarthe": { department: "Sarthe", departmentCode: "72" },
  "la-fleche": { department: "Sarthe", departmentCode: "72" },
  "allonnes": { department: "Sarthe", departmentCode: "72" },
  "les-herbiers": { department: "Vendée", departmentCode: "85" },
  "challans": { department: "Vendée", departmentCode: "85" },
  "fontenay-le-comte": { department: "Vendée", departmentCode: "85" },
  "les-sables-d-olonne": { department: "Vendée", departmentCode: "85" },
  "aizenay": { department: "Vendée", departmentCode: "85" },
  "luon-sur-mer": { department: "Vendée", departmentCode: "85" },
  // Provence-Alpes-Côte d'Azur
  "mandelieu-la-napoule": { department: "Alpes-Maritimes", departmentCode: "06" },
  "vence": { department: "Alpes-Maritimes", departmentCode: "06" },
  "manosque": { department: "Alpes-de-Haute-Provence", departmentCode: "04" },
  "digne-les-bains": { department: "Alpes-de-Haute-Provence", departmentCode: "04" },
  "istres": { department: "Bouches-du-Rhône", departmentCode: "13" },
  "gap": { department: "Hautes-Alpes", departmentCode: "05" },
  "la-crau": { department: "Var", departmentCode: "83" },
  "saint-maximin-la-sainte-baume": { department: "Var", departmentCode: "83" },
  "brignoles": { department: "Var", departmentCode: "83" },
  "carpentras": { department: "Vaucluse", departmentCode: "84" },
  "orange": { department: "Vaucluse", departmentCode: "84" },
  "cavaillon": { department: "Vaucluse", departmentCode: "84" },
  "pertuis": { department: "Vaucluse", departmentCode: "84" },
  // Île-de-France
  "palaiseau": { department: "Essonne", departmentCode: "91" },
  "etampes": { department: "Essonne", departmentCode: "91" },
  "bretigny-sur-orge": { department: "Essonne", departmentCode: "91" },
  "mennecy": { department: "Essonne", departmentCode: "91" },
  "villemomble": { department: "Seine-Saint-Denis", departmentCode: "93" },
  "melun": { department: "Seine-et-Marne", departmentCode: "77" },
  "pontault-combault": { department: "Seine-et-Marne", departmentCode: "77" },
  "combs-la-ville": { department: "Seine-et-Marne", departmentCode: "77" },
  "montereau-fault-yonne": { department: "Seine-et-Marne", departmentCode: "77" },
  "lagny-sur-marne": { department: "Seine-et-Marne", departmentCode: "77" },
  "mitry-mory": { department: "Seine-et-Marne", departmentCode: "77" },
  "coulommiers": { department: "Seine-et-Marne", departmentCode: "77" },
  "fontainebleau": { department: "Seine-et-Marne", departmentCode: "77" },
  "herblay-sur-seine": { department: "Val-d'Oise", departmentCode: "95" },
  "villeneuve-saint-georges": { department: "Val-de-Marne", departmentCode: "94" },
  "sallanches": { department: "Haute-Savoie", departmentCode: "74" },
  "rumilly": { department: "Haute-Savoie", departmentCode: "74" },
  "saint-julien-en-genevois": { department: "Haute-Savoie", departmentCode: "74" },
};

// Appliquer les corrections
const allArrays = [citiesData, lyonSuburbs, marseilleSuburbs, additionalIdfCities, nationalExpansionCities];
allArrays.forEach(arr => {
  arr.forEach(city => {
    if (!city.departmentCode && departmentFixMap[city.slug]) {
      city.department = departmentFixMap[city.slug].department;
      city.departmentCode = departmentFixMap[city.slug].departmentCode;
    }
  });
});
